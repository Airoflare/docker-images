...
_Scanned 2026-09-25 with Trivy. OS and language package CVEs, fixed and unfixed. Counts change as new advisories are published and as `cloudflared` updates its dependencies; a weekly rebuild pulls in the newest release and base-image fixes._
<!-- TRIVY:END -->
